      ...
      function createAxis(dom) {
        ...
        if (orientation === "horizontal") {
          ...
          if (axis.orient() === "top") {
            ...
            g.attr("transform", "translate(" + margin + ",10)");
          }
        ...
        g.call(axis);
        //http://stackoverflow.com/questions/18257804/how-to-change-d3-tickmark-lines-to-circles
        var allTicks = g.selectAll("g.tick");
        allTicks.each(function() { d3.select(this).append("circle").attr("r", 10);});
        allTicks.selectAll("line").remove();
        //set the "margin-top" for the text
        g.selectAll("text").attr("y","15");
      }
